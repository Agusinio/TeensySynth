...
AudioSynthWaveform W_4AM_R;           // xy=94.03912353515625,545.847827911377
AudioSynthWaveform W_4FM_L;           // xy=96.28910827636719,437.8476810455322
AudioSynthWaveform W_4AM_L;           // xy=98.28910064697266,353.59768772125244
AudioSynthWaveform W_4FM_R;           // xy=97.53909301757812,627.8476839065552
AudioEffectEnvelope ENV_FM_R;         // xy=279.0017395019531,627.0018243789673
AudioEffectEnvelope ENV_AM_R;         // xy=283.50181579589844,545.0018119812012
AudioEffectEnvelope ENV_FM_L;         // xy=286.5017547607422,439.75174045562744
AudioEffectEnvelope ENV_AM_L;         // xy=289.5017623901367,359.5017366409302
AudioSynthWaveform W_Osc2_L;          // xy=430.03907775878906,732.0976715087891
AudioSynthNoisePink W_NoiseOsc2_L;    // xy=435.03907775878906,808.0976715087891
AudioSynthWaveform W_Osc2_R;          // xy=440.03907775878906,893.0976715087891
AudioSynthNoisePink W_NoiseOsc2_R;    // xy=444.03907775878906,983.0976715087891
AudioSynthNoisePink W_Noise_L;        // xy=453.03907775878906,1119.097671508789
AudioSynthNoisePink W_Noise_R;        // xy=454.03907775878906,1215.097671508789
AudioSynthWaveformModulated W_Osc1_L; // xy=515.7891025543213,455.3476781845093
AudioSynthWaveformModulated W_Osc1_R; // xy=517.0390930175781,637.0976982116699
AudioEffectMultiply MOD_AM_L;         // xy=673.5390472412109,370.3476724624634
AudioEffectMultiply MOD_AM_R;         // xy=673.5390472412109,559.8477001190186
AudioFilterStateVariable
    FIL_NoiseEQH_L; // xy=696.1128387451172,1106.8906478881836
AudioFilterStateVariable
    FIL_NoiseEQH_R; // xy=700.1128768920898,1258.8905849456787
AudioFilterStateVariable
    FIL_NoiseEQL_L; // xy=696.1128387451172,1106.8906478881836
AudioFilterStateVariable
    FIL_NoiseEQL_R;                   // xy=700.1128768920898,1258.8905849456787
AudioSynthNoisePink W_NoiseOsc1_R;    // xy=795.0390777587891,640.0976715087891
AudioSynthNoisePink W_NoiseOsc1_L;    // xy=807.0390853881836,443.0976686477661
AudioMixer4 MIX_Osc1AddNoise_L;       // xy=1048.0390853881836,350.0976686477661
AudioMixer4 MIX_Osc1AddNoise_R;       // xy=1050.039077758789,573.0976715087891
AudioMixer4 MIX_Osc2AddNoise_L;       // xy=1056.039077758789,752.0976715087891
AudioMixer4 MIX_Osc2AddNoise_R;       // xy=1061.039077758789,877.0976715087891
AudioEffectEnvelope ENV_Osc1_L;       // xy=1336.039176940918,351.43099784851074
AudioEffectEnvelope ENV_Osc1_R;       // xy=1356.0391540527344,570.430980682373
AudioEffectEnvelope ENV_Osc2_L;       // xy=1359.7057266235352,746.7643632888794
AudioEffectEnvelope ENV_Noise_L;      // xy=1359.039077758789,1053.097671508789
AudioEffectEnvelope ENV_Osc2_R;       // xy=1363.039207458496,881.4309635162354
AudioEffectEnvelope ENV_Noise_R;      // xy=1362.039077758789,1262.097671508789
AudioFilterStateVariable FIL_Noise_R; // xy=1612.3724212646484,1270.7643375396729
AudioFilterStateVariable FIL_Noise_L; // xy=1616.039077758789,1061.097671508789
AudioMixer4 MIX_Osc_R;                // xy=1667.1431045532227,990.5716094970703
AudioMixer4 MIX_Osc_L;                // xy=1668.5715827941895,883.4286003112793
AudioMixer4 MIX_2Reverb_L;            // xy=2056.0390090942383,576.0976753234863
AudioMixer4 MIX_2Reverb_R;            // xy=2072.0390090942383,987.0976753234863
AudioFilterLadder FILMoog_L;          // xy=2227.0390090942383,461.0976753234863
AudioFilterLadder FILMoog_R;     // xy=2226.0390090942383,1111.0976753234863
AudioEffectEnvelope ENV_Final_L; // xy=2355.0390090942383,620.0976753234863
AudioEffectEnvelope ENV_Final_R; // xy=2386.0390090942383,966.0976753234863
AudioEffectFreeverbStereo RVR_Final_L; // xy=2396.0390090942383,735.0976753234863
AudioEffectFreeverbStereo RVR_Final_R; // xy=2404.0390090942383,868.0976753234863
AudioMixer4 MIX_Final_L; // xy=2627.0390090942383,674.0976753234863
AudioMixer4 MIX_Final_R; // xy=2645.0390090942383,979.0976753234863
AudioOutputI2S2 i2s2_1;  // xy=2677.0390090942383,795.0976753234863
// AudioOutputUSB           usb1; //xy=2677.0390090942383,856.0976753234863
AudioConnection patchCord1(W_4AM_L, ENV_AM_L);
AudioConnection patchCord2(W_4AM_R, ENV_AM_R);
AudioConnection patchCord3(W_4FM_L, ENV_FM_L);
AudioConnection patchCord4(W_4FM_R, ENV_FM_R);
AudioConnection patchCord5(ENV_FM_R, 0, W_Osc1_R, 1);
AudioConnection patchCord6(ENV_AM_R, 0, MOD_AM_R, 0);
AudioConnection patchCord7(ENV_FM_L, 0, W_Osc1_L, 1);
AudioConnection patchCord8(ENV_AM_L, 0, MOD_AM_L, 0);
AudioConnection patchCord9(W_Osc1_L, 0, MOD_AM_L, 1);
AudioConnection patchCord10(W_Osc1_R, 0, MOD_AM_R, 1);
AudioConnection patchCord11(W_NoiseOsc1_R, 0, MIX_Osc1AddNoise_R, 1);
AudioConnection patchCord12(W_NoiseOsc1_L, 0, MIX_Osc1AddNoise_L, 1);
AudioConnection patchCord13(MOD_AM_L, 0, MIX_Osc1AddNoise_L, 0);
AudioConnection patchCord14(MOD_AM_R, 0, MIX_Osc1AddNoise_R, 0);
AudioConnection patchCord15(W_Osc2_L, 0, MIX_Osc2AddNoise_L, 0);
AudioConnection patchCord16(W_NoiseOsc2_L, 0, MIX_Osc2AddNoise_L, 1);
AudioConnection patchCord17(W_Osc2_R, 0, MIX_Osc2AddNoise_R, 0);
AudioConnection patchCord18(W_NoiseOsc2_R, 0, MIX_Osc2AddNoise_R, 1);
AudioConnection patchCord19(MIX_Osc1AddNoise_L, ENV_Osc1_L);
AudioConnection patchCord20(MIX_Osc1AddNoise_R, ENV_Osc1_R);
AudioConnection patchCord21(MIX_Osc2AddNoise_L, ENV_Osc2_L);
AudioConnection patchCord22(MIX_Osc2AddNoise_R, ENV_Osc2_R);
AudioConnection patchCord23(ENV_Osc1_L, 0, MIX_Osc_L, 0);
AudioConnection patchCord24(ENV_Osc1_R, 0, MIX_Osc_R, 0);
AudioConnection patchCord25(ENV_Osc2_L, 0, MIX_Osc_L, 1);
AudioConnection patchCord26(ENV_Osc2_R, 0, MIX_Osc_L, 1);
AudioConnection patchCord27(W_Noise_L, 0, FIL_NoiseEQH_L, 0);
AudioConnection patchCord28(W_Noise_R, 0, FIL_NoiseEQH_R, 0);
AudioConnection patchCord29(FIL_NoiseEQH_L, 0, FIL_NoiseEQL_L, 0);
AudioConnection patchCord30(FIL_NoiseEQH_R, 1, FIL_NoiseEQL_R, 1);
AudioConnection patchCord31(FIL_NoiseEQL_L, 2, ENV_Noise_L, 2);
AudioConnection patchCord32(FIL_NoiseEQL_R, 0, ENV_Noise_R, 0);
AudioConnection patchCord34(MIX_Osc_L, 0, MIX_2Reverb_L, 0);
AudioConnection patchCord35(MIX_Osc_R, 0, MIX_2Reverb_R, 0);
AudioConnection patchCord36(ENV_Noise_L, 0, MIX_2Reverb_L, 1);
AudioConnection patchCord37(ENV_Pink_R, 0, MIX_2Reverb_R, 1);
AudioConnection patchCord38(MIX_2Reverb_L, 0, FILMoog_L, 0);
AudioConnection patchCord39(MIX_2Reverb_R, 0, FILMoog_R, 0);
AudioConnection patchCord40(FILMoog_L, ENV_Final_L);
AudioConnection patchCord41(FILMoog_R, ENV_Final_R);
AudioConnection patchCord42(ENV_Final_L, 0, MIX_Final_L, 0);
AudioConnection patchCord43(ENV_Final_R, 0, MIX_Final_R, 0);
AudioConnection patchCord44(ENV_Final_L, RVR_Final_L);
AudioConnection patchCord45(ENV_Final_R, RVR_Final_R);
AudioConnection patchCord46(RVR_Final_L, 0, MIX_Final_L, 1);
AudioConnection patchCord47(RVR_Final_L, 1, MIX_Final_R, 2);
AudioConnection patchCord48(RVR_Final_R, 0, MIX_Final_L, 2);
AudioConnection patchCord49(RVR_Final_R, 1, MIX_Final_R, 1);
// AudioConnection          patchCord51(MIX_Final_L, 0, usb1, 0);
AudioConnection patchCord50(MIX_Final_L, 0, i2s2_1, 0);
// AudioConnection          patchCord53(MIX_Final_R, 0, usb1, 1);
AudioConnection patchCord51(MIX_Final_R, 0, i2s2_1, 1);
AudioControlSGTL5000 sgtl5000_1; // xy=2079.0391387939453,1250.0976810455322
...
void myControlChange(byte channel, byte control, byte value) {
  ...
  case CCOsc1Lvl: { // Varia Gain a
    ...
    W_Osc1_L.gain(0, Osc1GainValue); // TEST gain limit to 0.3
    W_Osc1_R.gain(0, Osc1GainValue);
  } break;
  ...
  case CCOsc2Lvl: {
    ...
    W_Osc2_L.gain(0, Osc2GainValue); // TEST gain limit to 0.3
    W_Osc2_R.gain(0, Osc2GainValue);
  } break;
